...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = `Hi NIKNEX, I'm ${formData.name}. ${formData.message}. My contact: ${formData.phone}`;
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            We're here to help. Contact us for any inquiries or services
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-primary/15 to-accent/15 border border-primary/30 rounded-lg p-6 hover:border-accent/50 transition">
              ...
              <a href="tel:+919876543210" className="text-primary font-bold hover:text-accent transition">
                +91 98765 43210
              </a>
            </div>
